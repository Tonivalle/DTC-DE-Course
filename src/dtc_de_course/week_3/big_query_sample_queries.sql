...
SELECT * FROM vast-bounty-142716.trips_data_all.external_yellow_tripdata limit 10;

-- Create a non partitioned table from external table
CREATE OR REPLACE TABLE vast-bounty-142716.trips_data_all.yellow_tripdata_non_partitoned AS
